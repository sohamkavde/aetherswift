        ...
        <div className="relative flex flex-col md:flex-row justify-between space-y-10 md:space-y-0 md:space-x-10 md:px-10">
         ...
         {/* making its font small and height thin */}
          <div className="md:min-h-[600px] space-y-5">
            ...
            {/* Price Indicator */}
            <div className="flex items-center justify-center space-x-3 text-md text-second mb-4 border-t border-b py-4 border-brand font-medium">
              <span>
                Current price: <span className="text-white">$0.01</span>
              </span>
              <FaArrowRight className="text-second" />
              <span>
                Next price: <span className="text-white">$0.012</span>
              </span>
            </div>
            ...
            <div className="space-y-4 mb-6 px-0 md:px-12">
              <div>
                <label className="block text-second mb-1 capitalize">
                  You can Buy with
                </label>
              ...
              <div>
                <label className="block text-second mb-1 capitalize">You will get</label>
            ...
            {/* Approve Button */}
            <div className="px-0 md:px-12 flex justify-center gap-4">
              <button className="border border-gray-300  text-md md:2xl  bg-gray-500 hover:bg-gray-700 text-white  rounded-2xl font-bold mb-4 font-philosopher">
                Connect Wallet
              </button>
              <button className="border border-gray-300  text-md md:2xl  bg-brand hover:bg-red-700 text-white  rounded-2xl font-bold mb-4 font-philosopher">
                Approve
              </button>
            </div>
          </div>
