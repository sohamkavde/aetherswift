  ...
  return (
    <section className="bg-black text-white py-16 px-6 md:px-16">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-6xl text-gray-300 font-bold mb-4 font-philosopher">
          Roadmap
        </h2>
        <p className="text-xl mb-12  w-[75%] mx-auto">
        ...
        <div className="grid gap-y-0 gap-x-0">
          {/* Phase 1 */}
          <div className="col-span-2 grid grid-cols-1 md:grid-cols-2 gap-x-12 py-[5%] md:py-[0%] font-philosopher  ">
            <div
              className="bg-[#800000] bg-cover bg-center rounded-tr-3xl rounded-bl-3xl p-6 shadow-lg text-left space-y-4 border-2"
              style={{ backgroundImage: `url(${Bgdice})` }}
            >
              <div className="flex items-center gap-4">
                <div className="w-[36%]">{phases[0].icon}</div>
                <h3 className="text-2xl font-semibold">{phases[0].title}</h3>
              </div>
              <ul className="list-disc list-inside text-md pl-[5%] pt-[2%] text-white space-y-1">
          ...
          <div className="col-span-2 grid grid-cols-1 md:grid-cols-2 gap-x-12 py-[5%] md:py-[0%] font-philosopher " >
            <div></div>
            <div
              className="bg-[#800000] bg-cover bg-center rounded-tl-3xl rounded-br-3xl p-6 shadow-lg text-left space-y-4 border-2 md:-translate-y-[10%]"
              style={{ backgroundImage: `url(${Bgdice})` }}
            >
              <div className="flex items-center gap-4">
                <div className="w-[36%]">{phases[1].icon}</div>
                <h3 className="text-2xl font-semibold">{phases[1].title}</h3>
              </div>
              <ul className="list-disc list-inside text-md pl-[5%] pt-[2%] text-white space-y-1">
          ...
          <div className="col-span-2 grid grid-cols-1 md:grid-cols-2 py-[5%] md:py-[0%] font-philosopher  gap-x-12"  >
            <div
              className="bg-[#800000] bg-cover bg-center rounded-tr-3xl rounded-bl-3xl p-6 shadow-lg text-left space-y-4 border-2 md:-translate-y-[20%]"
              style={{ backgroundImage: `url(${Bgdice})` }}
            >
              <div className="flex items-center gap-4">
                <div className="w-[36%]">{phases[2].icon}</div>
                <h3 className="text-2xl font-semibold">{phases[2].title}</h3>
              </div>
              <ul className="list-disc list-inside text-md pl-[5%] pt-[2%] text-white space-y-1">
          ...
          <div className="col-span-2 grid grid-cols-1 md:grid-cols-2 py-[5%] md:py-[0%] font-philosopher  gap-x-12" >
            <div></div>
            <div
              className="bg-[#800000] bg-cover bg-center rounded-tl-3xl rounded-br-3xl p-6 shadow-lg text-left space-y-4 border-2 md:-translate-y-[30%]"
              style={{ backgroundImage: `url(${Bgdice})` }}
            >
              <div className="flex items-center justify-center gap-4">
                <div className="w-[36%]">{phases[3].icon}</div>
                <h3 className="text-2xl font-semibold">{phases[3].title}</h3>
              </div>
              <ul className="list-disc list-inside text-md pl-[5%] pt-[2%] text-white space-y-1">
